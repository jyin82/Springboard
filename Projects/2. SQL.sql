...
SELECT COUNT( Membercost >0 ) AS Num_Membercost
FROM Facilities
LIMIT 0 , 30
...
SELECT DISTINCT Bookings.facid, Bookings.memid, CONCAT( Members.firstname, ' ', Members.surname ) AS Guest, Facilities.name
